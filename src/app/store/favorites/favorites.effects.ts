...
export class FavoritesEffects {
    ...
    loadFavorites$ = createEffect(() => this.actions$.pipe(
        ...
        mergeMap(action => this.favoritesService.getFavorites(action.userId)
            .pipe(
    ...
    addFavorite$ = createEffect(() => this.actions$.pipe(
        ...
        mergeMap(action => this.favoritesService.addFavorite(action.favorite)
            .pipe(
    ...
    removeFavorite$ = createEffect(() => this.actions$.pipe(
        ...
        mergeMap(action => this.favoritesService.removeFavorite(action.id)
            .pipe(
